...
const ProfilePage = () => {
    ...
    return (
        <MainLayout>
            <section className="flex pt-10 w-full h-[50vw]">
                    <div className="w-full max-w-sm mx-auto p-1  inline-grid">
                        ...
                        <form onSubmit={handleSubmit(submitHandler)}>
                            ...
                            <button
                                ...
                                className="bg-yellow-500 text-white font-bold text-lg py-4 px-8 w-full rounded-lg mb-6 disabled:opacity-70 disabled:cursor-not-allowed"
                            >
                                Update
                            </button>
                        </form>
                    </div>
                <div className={`hidden md:block m-5 mt-0 basis-1/2 bg-no-repeat bg-cover bg-center`} style={{ backgroundImage: `url(${images.ProfilelogoPic})` }} />
            </section>
        </MainLayout>
    );
};
